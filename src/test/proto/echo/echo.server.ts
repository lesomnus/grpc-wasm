...
export interface IEchoService<T = ServerCallContext> {
     ...
     */
    serverStream(request: Echo, responses: RpcInputStream<Echo>, context: T): Promise<void>;
    /**
     * @generated from protobuf rpc: BidiStream(stream echo.Echo) returns (stream echo.Echo);
     */
    bidiStream(requests: RpcOutputStream<Echo>, responses: RpcInputStream<Echo>, context: T): Promise<void>;
}
